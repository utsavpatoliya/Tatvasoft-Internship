...
namespace Mission.Service.IServices
{
    public interface IMissionService
    {
        ...
        List<RecentVolunteerResponseModel> RecentVolunteerList(MissionApplication missionApplication);

        List<UserShareInviteResponseModel> GetUserList(int userId);

        string SendInviteMissionMail(List<MissionShareInviteRequestModel> user);
    }
}
